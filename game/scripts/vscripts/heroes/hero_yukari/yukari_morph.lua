...
function modifier_yukari_morph:OnCreated(table)
    ...
    if IsServer() then
        ...
        if not self.particle_time then
            self.particle_time = ParticleManager:CreateParticle("particles/yukari_morph.vpcf", PATTACH_ABSORIGIN_FOLLOW,
                self.parent)
        end
...
function modifier_yukari_morph_real:OnCreated(table)
    ...
    if IsServer() then
        if not self.particle_time then
            self.particle_time = ParticleManager:CreateParticle("particles/yukari_true_moon.vpcf",
