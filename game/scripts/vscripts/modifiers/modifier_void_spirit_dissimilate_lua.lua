...
function modifier_void_spirit_dissimilate_lua:PlayEffects1( point, main )
	-- Get Resources
	local particle_cast = "particles/void_spirit_dissimilate1.vpcf"
...
function modifier_void_spirit_dissimilate_lua:PlayEffects2( point, hit )
	-- Get Resources
	local particle_cast = "particles/void_spirit_dissimilate_dmg1.vpcf"
	local particle_cast2 = "particles/void_spirit_dissimilate_exit1.vpcf"
